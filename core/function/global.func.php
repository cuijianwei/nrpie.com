 ...
 * @return array
 */
function buildPage($type,$args,$total_count,$page = 1,$page_size = 0,$url='',$offset = 2)
{
	global $_FANWE;
 ...
 * @return array
 */
function buildPage2($type,$args,$total_count,$page = 1,$page_size = 0,$url='',$offset = 5)
{
	global $_FANWE;
	...
	else
	{
        ...
        if(is_array($pager['page_nums']) && count($pager['page_nums'])>1){
            //$pager['page_nums'][0]= '';
             $pager['page_nums'][0][name]= '...';
             $pager['page_nums'][0][url]= '';
             $pager['page_next']= '';
             $pager['page_last']= '';
             $pager['next_page']= '';
             $pager['pager2']= 1;
